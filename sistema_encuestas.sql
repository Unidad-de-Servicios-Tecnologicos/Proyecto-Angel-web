...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-06-2024 a las 16:34:23
...
VALUES
  ...
  (
    3,
    1,
    'Probemos ahora si dice leida',
    'La leida dice que si funkaa',
    0,
    '2023-01-15 00:37:48',
    '2023-01-16 00:37:30'
  );
...
--
INSERT INTO
  `opciones` (`id_opcion`, `id_pregunta`, `valor`)
VALUES
  (4, 2, '123'),
  (5, 2, '123'),
  (6, 2, '12412'),
...
--
INSERT INTO
  `resultados` (`id_resultado`, `id_opcion`)
VALUES
  (5, 11),
  (2, 12),
  (8, 12),
...
--
INSERT INTO
  `tipo_pregunta` (`id_tipo_pregunta`, `nombre`, `descripcion`)
VALUES
  (
    1,
    'Selección múltiple',
    'Se podrá escoger solo una opción\r\nelemento input type radio'
  ),
  (
    2,
    'Desplegable',
    'Se podrá escoger una opción\r\nElemento select y option'
  ),
  (
    3,
    'Casilla de verificación',
    'Se podrá escoger más de una opción\r\ninput type checkbox'
  ),
...
--
INSERT INTO
  `tipo_usuario` (`id_tipo_usuario`, `nombre`)
VALUES
  (1, 'Administrador'),
  (2, 'Usuario');
...
--
INSERT INTO
  `usuarios_encuestas` (`id_usuario`, `id_encuesta`)
VALUES
  ('2', 1),
  ('2', 2),
  ('3', 2),
...
ALTER TABLE
  `usuarios_encuestas`
ADD
  CONSTRAINT `usuarios_encuestas_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD
...
ALTER TABLE
  organizacion
MODIFY
  id_organizacion INT(10) NOT NULL AUTO_INCREMENT;