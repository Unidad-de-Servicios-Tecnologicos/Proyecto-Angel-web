...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-07-2024 a las 23:47:01
...
CREATE TABLE `organizacion` (
  ...
  `pagina_de_la_or` text NOT NULL,
  `usuario_id` varchar(15) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL
...
INSERT INTO `organizacion` (`id_organizacion`, `años_de_experiencia`, `nombre_de_la_or`, `sigla_de_la_or`, `cargo_en_la_or`, `naturaleza_de_la_or`, `clase_de_la_or`, `ciudad_de_la_or`, `departamento_de_la_or`, `direccion_de_la_or`, `telefono_de_la_or`, `pagina_de_la_or`, `usuario_id`) VALUES
(11, '5', '765567657657', 'tytttyytt', 'tytytytyty', 'tyuyty', 'tytyuytyty', 'Popayán', 'Cauca', 'tytyyuyty', '65776765765', 'yyyyttytyty', '2');
...
INSERT INTO `usuarios` (`id_usuario`, `clave`, `nombres`, `apellidos`, `email`, `id_tipo_usuario`, `telefono`, `celular`) VALUES
('1', '123', 'Miguel', 'Talizo', 'talizomiguel@talizo.com', 1, 0, 0),
('2', '123', 'Rodrigo', 'Martinez', 'rodri@asd', 2, 0, 0),
('3', '123', 'Ramon', 'Castillo', 'ramon@asd', 2, 0, 0),
('4', '123', 'Lurin', 'Portillo', 'asd@asd', 2, 0, 0);
...
--
ALTER TABLE `organizacion`
  MODIFY `id_organizacion` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `organizacion`
  ADD CONSTRAINT `fk_user_id` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id_usuario`);
